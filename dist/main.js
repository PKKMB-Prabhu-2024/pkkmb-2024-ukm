document.addEventListener("DOMContentLoaded", function() {
    ...
    window.addEventListener("resize", function() {
        ...
        if (window.screen.width <= 1024) {
            // ukm27.classList.add("detail-visible");
            // ukm27.style.width = "100%";
            // ukm27.style.height = "auto";
            // p27.style.opacity = "1";
            // wa27.style.opacity = "1";
            // logo27.style.opacity = "1";

            ukm27.removeEventListener("mouseoenter", cursorIn);
            ukm27.removeEventListener("mouseleave", cursorOut);
        } else {
            // ukm27.classList.remove("detail-visible");
            // ukm27.style.width = "";
            // ukm27.style.height = "";
            // p27.style.opacity = "0";
